              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mt-11">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="w-5 h-5 shrink-0 text-brand-orange"
                    aria-hidden="true"
                  >
          ...
          <div className="mt-20 flex flex-wrap items-center justify-between gap-6 rounded-3xl border border-gray-200 bg-card p-8 md:p-10">
            <div>
              ...
              <p className="mt-2 text-gray-400">
                Te enviamos una propuesta personalizada en menos de 72 horas.
              </p>
            </div>
            <a
              href="#contacto"
              className="inline-flex items-center gap-2 rounded-full bg-brand-blue-light text-primary-white px-7 py-3.5 text-white font-semibold hover:bg-brand-blue/90 transition"
            >
              Empezar mi proyecto{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
